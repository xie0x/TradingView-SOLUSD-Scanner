...
const formatReadme = (data) => {
  ...
  formattedReadme.push('# TradingView SOLUSD Scanner (1H)')
  ...
  formattedReadme.push('SOLUSD recommendation scanner based on real-time TradingView data Scanner API')
...
const main = async () => {
  try {
    ...
    await fs.writeJson('datasol.json', { updated: formattedDate, data }, { spaces: 2 })

    const historyFile = 'solprice_history.json'
    let history = []
